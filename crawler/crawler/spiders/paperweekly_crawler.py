...
class PaperweeklyCrawlerSpider(scrapy.Spider):
    ...
    header = {
        ...
        'Authorization': 'Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJ1c2VybmFtZSI6InZ2bHZ2dSIsImVtYWlsIjoiNDUyMTk1OTg2QHFxLmNvbSIsImV4cCI6MTkyNDc1NzY4NCwib3JpZ19pYXQiOjE2MDkzOTc2ODQsInVzZXJfaWQiOiJhN2E5ZTFhNS0xOGYxLTQyZGMtYTE4My00YWNkOGY2YWE0NzAifQ.cS2WYuDbIPwyPxtPmWJ1xQLEXtFmlKzoCoxS7mmBnPM'
    }
    """
    def __init__(self):
        cook_dict = {}
    ...
    def parse_paper(self, response):
        content = response.xpath(
            "/html/body[@class='with-cu-identity']/div[@class='flex-wrap-footer']/main/div[@id='content']/div[@id='abs-outer']/div[@class='leftcolumn']/div[@id='content-inner']/div[@id='abs']"
        )
        title = content.xpath(
        ...
        paper_url = response.xpath(
            "/html/body[@class='with-cu-identity']/div[@class='flex-wrap-footer']/main/div[@id='content']/div[@id='abs-outer']/div[@class='extra-services']/div[@class='full-text']/ul//a[@class='abs-button download-pdf']/@href")[
            0].extract()
